...
export default function Tools() {
  ...
  <div className="mx-auto mt-6 max-w-xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 gap-y-8 lg:px-8">
      ...
      <div className="inline-flex rounded-md shadow">
        <a href="/video" className="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base text-xl text-white hover:bg-indigo-700"><div className="text-2xl font-semibold">Documentary</div> <br/> (video)</a>
      </div>
      ...
      <div className="inline-flex rounded-md shadow">
        <a href="/tellherstory" className="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base text-xl text-white hover:bg-indigo-700"><div className="text-2xl font-semibold">Submit </div> <br/> (tell her story)</a>
      </div>
